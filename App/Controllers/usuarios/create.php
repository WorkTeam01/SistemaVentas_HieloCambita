...
if ($password_user == $password_repeat) {
    ...
    (Usuario, NombresUsuario, ApellidosUsuario, EmailUsuario, IdRolUsuario, PasswordUsuario)
    VALUES (:Usuario, :NombresUsuario, :ApellidosUsuario, :EmailUsuario, :IdRolUsuario, :PasswordUsuario)");
